...
#Panel Izquierdo
lTopPanel = Frame(leftPanel,background="#F39C12",padx=50,pady=85)
lBottomPanel = Frame(leftPanel,background="#FFA07A",width=350,padx=85,pady=95)
lTopPanel.pack()
lBottomPanel.pack()
...
btnExportar.grid(row=0,column=0)
btnImportar.grid(row=0,column=1)



#Panel Izquierdo Inferior
titleLabelBL = Label(lBottomPanel, text=tiempoSimulacion)
SLabel = Label(lBottomPanel,text=St)
ELabel = Label(lBottomPanel,text=Et)
ILabel = Label(lBottomPanel, text=It)
LLabel = Label(lBottomPanel, text=Lt)
...
ELabel.grid(row=0,column=2)
ILabel.grid(row=0,column=3)
LLabel.grid(row=0,column=4)
